rojeto de Extensão: Finance Beam
...
Requisitos
    ...
    Node.js versão 25.9.0 ou inferior. Versões mais recentes do Node.js não apresentam compatibilidade total com a biblioteca better-sqlite3
...
npm install
    ...
    Reconstrua os Módulos do Electron (se aplicável):
